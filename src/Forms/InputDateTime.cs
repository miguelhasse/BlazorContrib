...
public class InputDateTime<TValue> : InputDate<TValue>
{
    ...
    {
        if (BindConverter.TryConvertToDateTime(value, CultureInfo.InvariantCulture, DateFormat, out var parsedValue))
        {
    ...
    {
        if (BindConverter.TryConvertToDateTimeOffset(value, CultureInfo.InvariantCulture, DateFormat, out var parsedValue))
        {
            result = (TValue)(object)parsedValue;
            return true;
        }
