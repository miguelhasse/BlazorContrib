...
internal static class EditFormTestHost
{
    ...
    public static RenderFragment<EditContext> DynamicFormFields(
        ...
        bool readOnly = false,
        bool disabled = false,
        RenderFragment<DynamicFormField>? fieldTemplate = null,
        EventCallback<object> onModelChanged = default) => _ => builder =>
    {
        ...
        if (onModelChanged.HasDelegate)
            builder.AddAttribute(6, "OnModelChanged", onModelChanged);
